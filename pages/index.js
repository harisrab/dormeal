    ...
    >
      ...
      <div className="mt-[180px]">
        ...
        <p className="text-center font-roboto font-normal">
          Order food right at your dorms front door.<br></br>All in just a few
          clicks.
        </p>
      </div>
      <div>
        <button
          onClick={signIn}
          className="btn btn-primary gap-8 w-[100%] rounded-full px-8 normal-case font-roboto font-normal text-[16px] bg-{#9F3E1F} text-lightBrown"
        >
          <svg
